...
public class MenuFrameView extends JFrame {
    ...
    public MenuFrameView() {
        ...
        JMenuItem copiarArquivoMenu = new JMenuItem("Copiar");
        copiarArquivoMenu.setMnemonic('C');
        arquivoMenu.add(copiarArquivoMenu);

        JMenuItem moverArquivoMenu = new JMenuItem("Mover");
        moverArquivoMenu.setMnemonic('M');
        arquivoMenu.add(moverArquivoMenu);

        JMenuItem renomearArquivoMenu = new JMenuItem("Renomear");
        renomearArquivoMenu.setMnemonic('R');
        arquivoMenu.add(renomearArquivoMenu);

        JMenuItem apagarArquivoMenu = new JMenuItem("Apagar");
        apagarArquivoMenu.setMnemonic('A');
        arquivoMenu.add(apagarArquivoMenu);
